    ...
    <>
      ...
      >
        <DropdownMenuTrigger asChild>
          ...
          >
            <span
              className="flex aspect-square size-8 items-center justify-center rounded bg-indigo-600 p-2 font-medium text-white text-xs dark:bg-indigo-500"
              aria-hidden="true"
            >
              RA
            </span>
            <div className="flex w-full items-center justify-between gap-x-4 truncate">
              <div className="truncate">
                <p className="truncate whitespace-nowrap font-medium text-gray-900 text-sm dark:text-gray-50">
                  Retail analytics
                </p>
                <p className="whitespace-nowrap text-left text-gray-700 text-xs dark:text-gray-300">
                  Member
                </p>
              </div>
              <RiExpandUpDownLine
              ...
              <DropdownMenuItem key={workspace.value}>
                <div className="flex w-full items-center gap-x-2.5">
                  <span
                    className={cx(
                      workspace.color,
                      'flex aspect-square size-8 items-center justify-center rounded p-2 font-medium text-white text-xs',
                    )}
                    aria-hidden="true"
                  >
                    {workspace.initials}
      ...
      >
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-x-1.5 rounded-md p-2 hover:bg-gray-100 focus:outline-none hover:dark:bg-gray-900">
            <span
              className={cx(
                'flex aspect-square size-7 items-center justify-center rounded bg-indigo-600 p-2 font-medium text-white text-xs dark:bg-indigo-500',
              )}
              aria-hidden="true"
            >
              RA
              ...
              <DropdownMenuItem key={workspace.value}>
                <div className="flex w-full items-center gap-x-2.5">
                  <span
                    className={cx(
                      workspace.color,
                      'flex size-8 items-center justify-center rounded p-2 font-medium text-white text-xs',
                    )}
                    aria-hidden="true"
                  >
                    {workspace.initials}
