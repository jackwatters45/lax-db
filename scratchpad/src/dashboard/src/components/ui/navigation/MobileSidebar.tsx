    ...
    <Drawer>
      <DrawerTrigger asChild>
        <Button
          ...
          className="group flex items-center rounded-md p-2 font-medium text-sm hover:bg-gray-100 data-[state=open]:bg-gray-100 data-[state=open]:bg-gray-400/10 hover:dark:bg-gray-400/10"
        >
          <RiMenuLine
