...
export const Route = createFileRoute('/_dashboard/playbook/')({
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link to="/playbook/practice">View All</Link>
                </Button>
              </div>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              ...
              {permissions.canManageCategories && (
                <Button
                  ...
                  asChild
                >
                  <Link to="/playbook/categories">Manage Categories</Link>
                </Button>
              )}
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" size="sm" asChild>
                  <Link to="/playbook/assignments">View All</Link>
                </Button>
              </div>
            </CardHeader>
            <CardContent>
