...
export const Route = createFileRoute('/_dashboard/scouting/teams/')({
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-md border border-input py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-ring"
              />
            </div>
      ...
      {filteredTeams.length > 0 ? (
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {filteredTeams.map((team) => (
            <TeamCard key={team.id} team={team} permissions={permissions} />
          ))}
        </div>
      ) : (
    ...
    <Card className="transition-shadow hover:shadow-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div>
            <div className="mb-1 font-medium text-sm text-green-700">
              Strengths
            </div>
          ...
          <div>
            <div className="mb-1 font-medium text-sm text-red-700">
              Weaknesses
            </div>
            <div className="text-xs">
