...
import { Array as Arr, Effect, Schema as S } from 'effect';
    ...
    effect: Effect.gen(function* () {
      ...
      return {
        getAll: (input: GetAllPlayersInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(GetAllPlayersInput)(input);
        ...
        create: (input: CreatePlayerInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(CreatePlayerInput)(input);
        ...
        getTeamPlayers: (input: GetTeamPlayersInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(GetTeamPlayersInput)(input);
        ...
        updatePlayer: (input: UpdatePlayerInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(UpdatePlayerInput)(input);
        ...
        updateTeamPlayer: (input: UpdateTeamPlayerInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(UpdateTeamPlayerInput)(input);
        ...
        addPlayerToTeam: (input: AddPlayerToTeamInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(AddPlayerToTeamInput)(input);
        ...
        removePlayerFromTeam: (input: RemovePlayerFromTeamInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(RemovePlayerFromTeamInput)(input);
        ...
        bulkRemovePlayersFromTeam: (input: BulkRemovePlayersFromTeamInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(BulkRemovePlayersFromTeamInput)(
              input,
            );
        ...
        deletePlayer: (input: DeletePlayerInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(DeletePlayerInput)(input);
            yield* db
              .delete(playerTable)
        ...
        bulkDeletePlayers: (input: BulkDeletePlayersInput) =>
          Effect.gen(function* () {
            const validated = yield* S.decode(BulkDeletePlayersInput)(input);
            yield* db
              .delete(playerTable)
