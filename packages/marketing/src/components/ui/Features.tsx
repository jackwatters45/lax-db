  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none inset-0 select-none">
        ...
        {/* Middle */}
        <div
          className="-z-10 absolute inset-y-0 left-1/2 my-[-5rem] w-px"
          style={{
            maskImage:
              'linear-gradient(transparent, white 5rem, white calc(100% - 5rem), transparent)',
          }}
        ...
        {/* 25% */}
        <div
          className="-z-10 absolute inset-y-0 left-1/4 my-[-5rem] hidden w-px sm:block"
          style={{
            maskImage:
              'linear-gradient(transparent, white 5rem, white calc(100% - 5rem), transparent)',
          }}
        ...
        {/* 75% */}
        <div
          className="-z-10 absolute inset-y-0 left-3/4 my-[-5rem] hidden w-px sm:block"
          style={{
            maskImage:
              'linear-gradient(transparent, white 5rem, white calc(100% - 5rem), transparent)',
          }}
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative font-semibold text-lg text-orange-500 tracking-tight">
            Smart Farming Solutions
            <div className="-left-[8px] absolute top-1 h-5 w-[3px] rounded-r-sm bg-orange-500" />
          </h2>
          <p className="mt-2 text-balance font-semibold text-3xl text-gray-900 tracking-tighter md:text-4xl">
                  ...
                  >
                    ...
                    <div className="-top-5 absolute left-4">
                      <div className="flex gap-1">
                        ...
                        <div className="whitespace-nowrap rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs ring-1 ring-gray-200">
                          Drivetrain Error
                        </div>
                      </div>
                    </div>
        ...
        <div className="col-span-2 my-auto px-2">
          <h2 className="relative font-semibold text-lg text-orange-500 tracking-tight">
            Easy Expansion
            <div className="-left-[7px] absolute top-1 h-5 w-[3px] rounded-r-sm bg-orange-500" />
          </h2>
          <p className="mt-2 text-balance font-semibold text-3xl text-gray-900 tracking-tighter md:text-4xl">
          ...
          <div className="pointer-events-none relative flex size-full h-[26rem] select-none items-center justify-center p-10">
            <div className="relative">
              <div className="absolute top-[6rem] left-[6rem] z-20">
                <div className="relative mx-auto w-fit rounded-full bg-gray-50 p-1 shadow-black/10 shadow-md ring-1 ring-black/10">
