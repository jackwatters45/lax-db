    ...
    <section aria-labelledby="cta-title" className="mx-auto max-w-6xl">
      <div className="grid items-center gap-8 sm:grid-cols-6">
        <div className="sm:col-span-2">
          <h2
            id="cta-title"
            className="scroll-my-60 text-balance font-semibold text-3xl text-gray-900 tracking-tighter md:text-4xl"
          >
            Ready to get started?
          </h2>
          <p className="mt-3 mb-8 text-gray-600 text-lg">
        ...
        <div className="relative isolate rounded-xl sm:col-span-4 sm:h-full">
          <Image
            ...
            height={1000}
            width={1000}
            className="-z-10 absolute inset-0 rounded-2xl blur-xl"
          />
          <Image
            alt="Farm with vehicles"
            src="/images/farm-footer.webp"
