    ...
    <div className="relative flex items-center">
      <div className="relative">
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="-inset-px absolute z-0 rounded-full bg-linear-to-r from-yellow-500 via-amber-500 to-orange-500 opacity-30 blur-xl"
        />
        <motion.div
          variants={createVariants({ scale: 1.08, delay: 0.1 })}
          initial="initial"
          animate="animate"
          className="relative z-0 min-h-[80px] min-w-[80px] rounded-full border bg-linear-to-b from-white to-orange-50 shadow-orange-500/20 shadow-xl"
        >
          <motion.div
          ...
          >
            <div className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-black/40 shadow-white/40 shadow-xs will-change-transform">
              ...
              >
                <div className="relative flex h-full w-full items-center justify-center rounded-full bg-linear-to-br from-white to-gray-300 shadow-black/40 shadow-lg">
