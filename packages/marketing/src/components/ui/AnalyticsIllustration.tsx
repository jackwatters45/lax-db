...
export default function FieldPerformance() {
  return (
    <div className="perspective-[4000px] perspective-origin-center h-150 shrink-0 overflow-hidden [mask-image:radial-gradient(white_30%,transparent_90%)]">
      <div className="-translate-y-10 -translate-z-10 -rotate-z-10 transform-3d rotate-x-10 rotate-y-20">
        <h3 className="text-gray-500 text-sm">Field Yield Performance</h3>
        <p className="mt-1 font-semibold text-3xl text-gray-900">
          32,227 bushels
        </p>
