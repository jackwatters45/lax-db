...
export default function Testimonial() {
  return (
    <section className="relative mx-auto w-full max-w-6xl overflow-hidden rounded-xl shadow-2xl shadow-[#366A79]/70">
      ...
      <div className="-right-14 absolute top-[19rem] w-[19rem] sm:top-[12rem] sm:right-3 sm:w-[23rem] md:top-[12rem] md:right-0 md:w-[25rem] lg:top-[16rem] lg:right-12 lg:w-[34rem]">
        <Image
          alt="clouds background"
      ...
      <div className="relative z-20 mb-20 p-8 sm:p-14 lg:p-24">
        <div className="">
          <blockquote className="relative max-w-2xl text-gray-900 text-xl leading-relaxed tracking-tight md:text-2xl lg:text-3xl">
        ...
        <div className="mt-14 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
          ...
          <div>
            ...
            <div className="text-[#C33621]/80 text-sm">
